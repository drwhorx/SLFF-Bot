...
class TBA {
	...
	getTeamListKeys(pageNum, year) {
		return this.callAPI('teams' + (year === undefined ? '' : '/' + year) + '/' + pageNum + '/keys');
	}
	...
	getTeamEventAwards(teamNum, eventKey) {
		return this.callAPI('team/frc' + (teamNum.indexOf("frc") > -1 ? teamNum.slice(3) : teamNum) + '/event/' + eventKey + '/awards');
	}
